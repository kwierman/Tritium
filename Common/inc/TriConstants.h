...
namespace Tritium
{
	...
	const static TriScalar 				MGamowTeller 					= TriScalar(0.962*power(3.0,0.5) ); //Gamow Teller matrix element magnitude
	...
	const static TriTime 				TritiumLifetime 				= TriTime(TritiumHalfLife.Value() / log_taylor(2.0,0.5) ); //lifetime in seconds
