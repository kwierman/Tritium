...
namespace Tritium
{
	...
	const static TriMagneticFluxDensity Mu0 				= TriMagneticFluxDensity(4.0e-7*Pi); //vacuum magnetic permeability
	const static TriElectricFluxDensity Ep0 				= TriElectricFluxDensity( 1.0/(C*C*Mu0) ); //vacuum electric permittivity
	...
	const static TriScalar 				m_to_cm 			= TriScalar(100); //meters to centimeters conversion constant;
